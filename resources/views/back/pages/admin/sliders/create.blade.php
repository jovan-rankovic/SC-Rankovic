...
@section('header')
    <div class="header">
        <h2>
            ...
            <small>Dodavanje slider slika</small>
        </h2>
    </div>
@endsection
    ...
    <div class="body">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                <p class="lead">Dodaj slider sliku</p>
                <form action="{{ url('/admin/sliders') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <button type="submit" name="sliderBtn" id="sliderBtn" class="btn btn-dark waves-effect waves-light">Dodaj</button>
