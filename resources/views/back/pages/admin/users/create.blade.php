            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <form action="{{ url('/energijapp/users') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input name="first_name" id="first_name" type="text" class="form-control" placeholder="Ime" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input name="last_name" id="last_name" type="text" class="form-control" placeholder="Prezime" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input name="password" id="password" type="password" class="form-control" placeholder="Lozinka" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                    ...
                    @if(session('user')->role->name == 'admin')
                        <div class="form-group">
                            ...
                            @foreach($roles as $role)
                                <input id="role{{ $role->id }}" name="role_id" type="radio" value="{{ $role->id }}" />
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input name="card_number" id="card_number" type="text" class="form-control" placeholder="Broj kartice" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input name="address" id="address" type="text" class="form-control" placeholder="Adresa" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" name="userBtn" id="userBtn" class="btn btn-dark waves-effect waves-light">Dodaj</button>
