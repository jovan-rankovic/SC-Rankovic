            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <form action="{{ url('/admin/posts') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input name="title" id="title" type="text" class="form-control" placeholder="Naslov" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <textarea name="contentP" id="contentP" class="form-control" placeholder="Sadržaj" rows="15" required ></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="submit" name="postBtn" id="postBtn" class="btn btn-dark waves-effect waves-light">Dodaj</button>
